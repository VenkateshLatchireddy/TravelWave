...
export class EmailService {
  ...
  private async sendEmail(options: EmailOptions): Promise<void> {
    ...
    try {
      if (!this.transporter) {
        logger.warn('Email transporter is not configured. Skipping actual send.');
        return;
      }
  ...
  // Template Methods
  public async sendWelcomeEmail(user: any, verificationToken: string): Promise<void> {
  ...
  public async sendPasswordResetEmail(user: any, resetToken: string): Promise<void> {
  ...
  public async sendTripShareEmail(user: any, trip: any, shareUrl: string, recipientEmail?: string): Promise<void> {
  ...
  public async sendTripExportEmail(user: any, trip: any, pdfBuffer: Buffer, recipientEmail?: string): Promise<void> {
    const recipients = recipientEmail ? [recipientEmail] : [user.email];
  ...
  public async sendPasswordResetConfirmation(user: any): Promise<void> {
    const html = `
      <!DOCTYPE html>
      <html>
        <head>
